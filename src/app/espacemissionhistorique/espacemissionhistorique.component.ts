...
@Component({
  selector: 'app-espacemissionhistorique',
  templateUrl: './espacemissionhistorique.component.html',
  styleUrls: ['./espacemissionhistorique.component.css']
})
export class EspacemissionhistoriqueComponent implements OnInit {
