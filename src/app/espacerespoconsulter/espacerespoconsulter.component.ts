...
@Component({
  selector: 'app-espacerespoconsulter',
  templateUrl: './espacerespoconsulter.component.html',
  styleUrls: ['./espacerespoconsulter.component.css']
})
export class EspacerespoconsulterComponent implements OnInit {
 ...
 //   this.webSocket.commentaireEspace(this.numeroespace);
  ...
  fermerEspace(){
    this.router.navigate(["respInfo/interventionsencours"]);
